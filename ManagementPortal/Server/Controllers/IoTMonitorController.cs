...
{
    /// <summary>
    /// Controller que simula api del producto IoT.
    ...
    public class IoTMonitorController : ControllerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IoTMonitorController"/> class.
        /// </summary>
        /// <param name="configuration">Configuración de la aplicación.</param>
        /// <param name="dummyService">Servicio dummy para implementar otp.</param>
        public IoTMonitorController(IConfiguration configuration, OtpDummyService dummyService)
            : base()
        {
        ...
        /// <param name="sort">ordenación.</param>
        /// <param name="columna">columna.</param>
        /// <returns>Retorna el listado de usuarios según los filtros de buscado y paginado.</returns>
        [HttpGet("User")]
        public async Task<IActionResult> GetUsers([FromHeader(Name = "X-API-KEY")] string apiKey, int page = 1, int pageSize = 10, string query = "", string sort = "Ascending", string columna = "Name")
        {
            ...
            return Ok(SondaDummyFactory.ListUser(Products.IoTMonitor, order, query, field, pageSize, page));
        }
        ...
        public async Task<IActionResult> GetUser(string user_id, [FromHeader(Name = "X-API-KEY")] string apiKey)
        {
            ...
            var response = SondaDummyFactory.GetUser(Products.IoTMonitor, user_id);
        ...
        public async Task<IActionResult> CreateUser([FromBody] UserPostDto applicationUser, [FromHeader(Name = "X-API-KEY")] string apiKey)
        {
            ...
            var result = SondaDummyFactory.AddUser(Products.IoTMonitor, applicationUser);
        ...
        public async Task<IActionResult> UpdateUser([FromBody] UserPutDto newUserData, [FromHeader(Name = "X-API-KEY")] string apiKey)
        {
            ...
            if (SondaDummyFactory.UpdateUser(Products.IoTMonitor, newUserData))
            {
                return Ok();
            }
            else
        ...
        public async Task<IActionResult> DeleteUser(string userid, [FromHeader(Name = "X-API-KEY")] string apiKey)
        {
            ...
            if (SondaDummyFactory.RemoveUser(Products.IoTMonitor, userid))
            {
                return Ok();
            }
            else
        ...
        public async Task<IActionResult> ChangePassword([FromBody] UserPasswordPutDto model, [FromHeader(Name = "X-API-KEY")] string apiKey)
        {
            ...
            if (SondaDummyFactory.UpdatePasswordUser(Products.IoTMonitor, model))
            {
                return Ok();
            }
            else
        ...
        public async Task<IActionResult> CreateRole([FromBody] RoleGetDto role, [FromHeader(Name = "X-API-KEY")] string apiKey)
        {
            ...
            if (SondaDummyFactory.AddRol(Products.IoTMonitor, role))
            {
                return Ok();
            }
            else
        ...
        public async Task<IActionResult> DeleteRole(string roleId, [FromHeader(Name = "X-API-KEY")] string apiKey)
        {
            ...
            if (SondaDummyFactory.RemoveRol(Products.IoTMonitor, roleId))
            {
                return Ok();
            }
            else
        ...
        public async Task<IActionResult> GetRole(string roleName, [FromHeader(Name = "X-API-KEY")] string apiKey)
        {
            ...
            var result = SondaDummyFactory.GetRol(Products.IoTMonitor, roleName);
        ...
        public async Task<IActionResult> GetRoles([FromHeader(Name = "X-API-KEY")] string apiKey, int page = 1, int pageSize = 10, string query = "", string sort = "Ascending", string columna = "Name")
        {
            ...
            return Ok(SondaDummyFactory.ListRol(Products.IoTMonitor, order, query, field, pageSize, page));
        }

        /// <summary>
        /// Actualizar un rol en el IoTMonitor.
        /// </summary>
        ...
        public async Task<IActionResult> UpdateRole(string id, [FromBody] RoleGetDto roleEdit, [FromHeader(Name = "X-API-KEY")] string apiKey)
        {
            ...
            if (SondaDummyFactory.UpdateRol(Products.IoTMonitor, roleEdit))
            {
                return Ok();
            }
            else
        ...
        /// <param name="query">The search query to filter permissions.</param>
        /// <param name="sort">The sort order, either "Ascending" or "Descending". Default is "Ascending".</param>
        /// <param name="columna">The column to sort by. Default is "Name".</param>
        /// <param name="apiKey">The API key for authentication.</param>
        /// <returns>Retorna una lista de permisos basada en los filtros proporcionados y configuraciones de paginación.</returns>
        [HttpGet("Permissions")]
        public async Task<IActionResult> GetPermissions(int page = 1, int pageSize = 10, string query = "", string sort = "Ascending", string columna = "Name", [FromHeader(Name = "X-API-KEY")] string apiKey = "")
        {
            ...
            return Ok(SondaDummyFactory.ListPermission(Products.IoTMonitor, order, query, field, pageSize, page));
        }
